...
class LocationManager constructor(
    ...
    fun startLocationUpdates() {
        ...
        try {
            ...
            LocationClientLocator.getInstance().fusedLocationProviderClient?.requestLocationUpdates(
                locationRequest,
    ...
    fun stopLocationUpdates() {
        ...
        _receivingLocationUpdates.value = false
        LocationClientLocator.getInstance().fusedLocationProviderClient?.removeLocationUpdates(
            locationUpdatePendingIntent
        )
    }
